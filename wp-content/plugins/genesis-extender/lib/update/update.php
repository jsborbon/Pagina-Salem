...
function genesis_extender_update()
{
	...
	// Update to Genesis Extender 1.8.2
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.8.2', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.8.2' );
	}
	
	// Update to Genesis Extender 1.9.0
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.9.0', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.9.0' );
	}
	
	// Update to Genesis Extender 1.9.1
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.9.1', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.9.1' );
	}
	
	// Update to Genesis Extender 1.9.2
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.9.2', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.9.2' );
	}
	
	// Update to Genesis Extender 1.9.3
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.9.3', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.9.3' );
	}
	
	// Update to Genesis Extender 1.9.4
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.9.4', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.9.4' );
	}
...
{	
	...
	{
		wp_redirect( admin_url( 'admin.php?page=genesis-extender-dashboard&notice=genesis-extender-unwritable' ) );
	}
}
