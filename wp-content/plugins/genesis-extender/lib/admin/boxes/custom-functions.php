...
<div id="genesis-extender-custom-options-nav-functions-box" class="genesis-extender-optionbox-outer-1col genesis-extender-all-options">
	<div class="genesis-extender-optionbox-inner-1col">
		...
		<p style="margin:0;">
			<textarea data-editor="php" style="display:none;" wrap="off" id="genesis-extender-custom-functions" class="genesis-extender-tabby-textarea" name="custom_functions[custom_functions]" rows="29"><?php echo stripslashes( esc_textarea( $custom_functions['custom_functions'] ) ); ?></textarea>
		</p>
	</div>
</div>