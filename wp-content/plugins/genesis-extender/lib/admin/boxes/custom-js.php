...
<div id="genesis-extender-custom-options-nav-js-box" class="genesis-extender-optionbox-outer-1col genesis-extender-all-options">
	<div class="genesis-extender-optionbox-inner-1col">
		...
		<p style="margin:0;">
			<textarea data-editor="javascript" style="display:none;" wrap="off" id="genesis-extender-custom-js" class="genesis-extender-tabby-textarea" name="custom_js[custom_js]" rows="29"><?php echo stripslashes( esc_textarea( $custom_js['custom_js'] ) ); ?></textarea>
		</p>
	</div>
</div>