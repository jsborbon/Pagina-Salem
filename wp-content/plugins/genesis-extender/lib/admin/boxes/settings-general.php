	...
	<div class="genesis-extender-optionbox-2col-left-wrap">
			...
			<div class="genesis-extender-optionbox-inner-2col">
				...
				<div class="bg-box">	
					<p>
						...
						<a href="https://fonts.google.com/" class="tooltip-mark" target="_blank">[https://fonts.google.com/]</a>
						<span id="show-add-google-fonts" class="genesis-extender-options-reset-button button" style="float:none !important;">Google Fonts</span><a href="http://extenderdocs.cobaltapps.com/article/214-add-google-fonts" class="tooltip-mark" target="_blank">[?]</a>
		...
		<div class="genesis-extender-optionbox-outer-2col">
			<div class="genesis-extender-optionbox-inner-2col">
				...
				<div class="bg-box">
					<p>
						<input type="checkbox" id="genesis-extender-enable-ace-editor-syntax-validation" name="extender[enable_ace_editor_syntax_validation]" value="1" <?php if ( checked( 1, genesis_extender_get_settings( 'enable_ace_editor_syntax_validation' ) ) ); ?> /> <?php _e( 'Enable Ace Editor Syntax Validation Checking?', 'extender' ); ?>
					</p>
				</div>
			</div>
		</div>
			...
			<div class="genesis-extender-optionbox-inner-2col">
				...
				<div class="bg-box">	
					<p>
						...
						<a href="http://extenderdocs.cobaltapps.com/article/184-add-support-for-font-awesome-icons" class="tooltip-mark" target="_blank">[?]</a> | <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank"><span style="font-style:underline;"><?php _e( 'Click here to view available icons', 'extender' ); ?></a> 
					</p>
					<p id="genesis-extender-font-awesome-cdn-option" style="display:none;">
						<input type="checkbox" id="genesis-extender-font-awesome-cdn" name="extender[font_awesome_cdn]" value="1" <?php if( checked( 1, genesis_extender_get_settings( 'font_awesome_cdn' ) ) ); ?> /> <?php _e( 'Use Font Awesome CDN Link', 'extender' ); ?>
						<a href="http://extenderdocs.cobaltapps.com/article/269-use" class="tooltip-mark" target="_blank">[?]</a>
						<span id="genesis-extender-font-awesome-cdn-url-box" style="display:none;">
		 					<?php _e( 'Your CDN Link:', 'extender' ); ?> <input type="text" id="genesis-extender-font-awesome-cdn-url" name="extender[font_awesome_cdn_url]" value="<?php echo genesis_extender_get_settings( 'font_awesome_cdn_url' )?>" style="width:220px;" />
		 				</span>
					</p>
				</div>
			</div>
