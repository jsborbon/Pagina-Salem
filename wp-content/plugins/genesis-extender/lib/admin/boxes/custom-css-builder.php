...
<div style="display:none;" id="genesis-extender-custom-css-builder" class="genesis-extender-optionbox-outer-1col">
	<div class="genesis-extender-optionbox-inner-1col">
		<h3 style="width:805px; border-bottom:0;"><?php _e( 'Custom CSS Builder', 'coder' ); ?> <a href="http://extenderdocs.cobaltapps.com/article/97-custom-css-builder" class="tooltip-mark" target="_blank">[?]</a></h3>
		...
		<form name="form">
			<div id="genesis-extender-custom-css-builder-wrap-inner" class="bg-box">
				<div id="genesis-extender-custom-css-builder-nav">
					<ul>
						<li id="custom-css-builder-nav-open-close-elements" class="genesis-extender-css-builder-nav-all"><a href="#">Elements</a></li><li id="custom-css-builder-nav-backgrounds" class="genesis-extender-css-builder-nav-all"><a href="#">Backgrounds</a></li><li id="custom-css-builder-nav-borders" class="genesis-extender-css-builder-nav-all"><a href="#">Borders</a></li><li id="custom-css-builder-nav-border-radius" class="genesis-extender-css-builder-nav-all"><a href="#">Border Radius</a></li><li id="custom-css-builder-nav-margins" class="genesis-extender-css-builder-nav-all"><a href="#">Margins</a></li><li id="custom-css-builder-nav-padding" class="genesis-extender-css-builder-nav-all"><a href="#">Padding</a></li><li id="custom-css-builder-nav-fonts" class="genesis-extender-css-builder-nav-all genesis-extender-options-nav-active"><a href="#">Fonts</a></li><li id="custom-css-builder-nav-width-float" class="genesis-extender-css-builder-nav-all"><a href="#">Width/Float</a></li><li id="custom-css-builder-nav-shadows" class="genesis-extender-css-builder-nav-all"><a href="#">Shadows</a></li><li id="custom-css-builder-nav-responsive" class="genesis-extender-css-builder-nav-all"><a class="genesis-extender-options-nav-last" href="#">Responsive</a></li>
					</ul>
				</div>
				...
				<div id="custom-css-builder-nav-open-close-elements-box" class="genesis-extender-all-css-builder">
					<p style="float:left;">
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_primary_menu_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_secondary_menu_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_content_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_breadcrumb_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_archive_description_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_featured_content_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_sidebar_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_comment_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_comment_respond_elements_array() ); ?>
						</select>
						...
						<?php genesis_extender_build_css_builder_select_menu( genesis_extender_genesis_footer_widget_elements_array() ); ?>
						</select>
				...
				<div id="custom-css-builder-nav-border-radius-box" class="genesis-extender-all-css-builder">
					<div class="custom-css-builder-options-box-wrap">
						<div class="custom-css-builder-options-box">
							<?php _e( 'Tp-Lft', 'coder' ); ?>
				...
				<div id="custom-css-builder-nav-margins-box" class="genesis-extender-all-css-builder">
					<div class="custom-css-builder-options-box-wrap">
						<div class="custom-css-builder-options-box">
							<?php _e( 'Top', 'coder' ); ?>
				...
				<div id="custom-css-builder-nav-padding-box" class="genesis-extender-all-css-builder">
					<div class="custom-css-builder-options-box-wrap">
						<div class="custom-css-builder-options-box">
							<?php _e( 'Top', 'coder' ); ?>
				...
				<div id="custom-css-builder-nav-fonts-box" class="genesis-extender-all-css-builder genesis-extender-options-display">
					<p style="float:left;">
						...
						<input type="text" id="font_size" name="font_size" value="12" style="width:35px; height:25px;" /><code class="genesis-extender-px-unit">px</code><br />
				...
				<div id="custom-css-builder-nav-width-float-box" class="genesis-extender-all-css-builder">
					<p style="float:left;">		
						...
						<input type="text" id="width_px" name="width_px" value="" style="width:40px; height:25px;" /><code class="genesis-extender-px-unit">px</code><br />
						...
						<input type="text" id="width_percent" name="width_percent" value="" style="width:40px; height:25px;" /><code class="genesis-extender-px-unit">%</code><br />
						...
						<input type="text" id="max_width_px" name="max_width_px" value="" style="width:40px; height:25px;" /><code class="genesis-extender-px-unit">px</code><br />
						...
						<input type="text" id="max_width_percent" name="max_width_percent" value="" style="width:40px; height:25px;" /><code class="genesis-extender-px-unit">%</code><br />
						...
						<input type="text" id="height" name="height" value="" style="width:40px; height:25px;" /><code class="genesis-extender-px-unit">px</code><br />
				...
				<div id="custom-css-builder-nav-responsive-box" class="genesis-extender-all-css-builder">
					<div class="custom-css-builder-options-box-wrap">
						<div class="custom-css-builder-options-box">
				...
				<div id="css-builder-output-wrap">
					<textarea wrap="off" id="css-builder-output" class="genesis-extender-tabby-textarea code-builder-output" name="text"></textarea>
				</div>
			</div>
		</form>
