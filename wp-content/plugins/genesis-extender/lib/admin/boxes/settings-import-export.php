			...
			<div class="genesis-extender-optionbox-2col-left-wrap" style="padding: 0 10px;">
				...
				<div class="bg-box" style="margin-right:0; margin-bottom:0;">
					...
					<div class="genesis-extender-import-export-checkboxes-wrap">
						...
						<p>
							<input class="settings-export-check" type="checkbox" id="export-images" name="export_images" value="1" checked /> <?php _e( 'Uploaded Images', 'extender' ); ?>
						</p>
					</div>
					<p class="genesis-extender-import-export-action-fields">
						<input type="text" id="genesis-extender-export-name" class="default-text forbid-chars" name="genesis_extender_export_name" value="" title="Export File Name" style="width:100%;" />
					</p>
					<p class="genesis-extender-import-export-action-fields">
						<input type="submit" name="clicked_button" value="<?php _e( 'Export Custom Options', 'extender' ); ?>" class="button-highlighted genesis-extender-custom-fonts-button button rounded-button"/>
			...
			<div class="genesis-extender-optionbox-2col-right-wrap" style="padding: 0 10px;">
				...
				<div class="bg-box" style="margin-right:0; margin-bottom:0;">
					...
					<div class="genesis-extender-import-export-checkboxes-wrap">
						...
						<p>
							<input class="settings-import-check" type="checkbox" id="import-images" name="import_images" value="1" checked /> <?php _e( 'Uploaded Images', 'extender' ); ?>
						</p>
					</div>
					<p class="genesis-extender-import-export-action-fields">
					...
					<p class="genesis-extender-import-export-action-fields">
						<input type="submit" name="clicked_button" value="<?php _e( 'Import Custom Options', 'extender' ); ?>" class="button-highlighted genesis-extender-custom-fonts-button button rounded-button"/>
