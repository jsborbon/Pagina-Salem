		...
		<div class="genesis-extender-optionbox-outer-2col">
			<div class="genesis-extender-optionbox-inner-2col">
				...
				<div class="bg-box">
					...
					<p>
						<?php _e( 'Genesis Extender Version:', 'extender' ); ?> <b><code><?php echo esc_attr( GENEXT_VERSION ) ?></code></b> <a href="<?php echo GENEXT_URL . 'CHANGELOG.md'; ?>" target="_blank">(<?php _e( 'Change Log', 'extender' ); ?>)</a>
					</p>

					<?php if( genesis_extender_get_settings( 'font_awesome_css' ) ) { ?>
						<p>
							<?php _e( 'Font Awesome Version:', 'extender' ); ?> <b><code><?php echo esc_attr( GENEXT_FONT_AWESOME_VERSION ) ?></code></b>
						</p>
					<?php } ?>
				</div>
			</div>
