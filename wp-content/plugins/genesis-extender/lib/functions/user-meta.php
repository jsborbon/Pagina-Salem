	...
	<table class="form-table">
		<tbody>
			<tr>
				...
				<td>
					<input id="meta[disable_genesis_extender_admin_menu]" name="meta[disable_genesis_extender_admin_menu]" type="checkbox" value="1" <?php checked( get_the_author_meta( 'disable_genesis_extender_admin_menu', $user->ID ) ); ?> />
					<label for="meta[disable_genesis_extender_admin_menu]"><?php _e( 'Disable Genesis Extender Admin Menu?', 'extender' ); ?></label><br />
					...
					<label for="meta[disable_genesis_extender_custom_menu]"><?php _e( 'Disable Genesis Extender Custom Submenu?', 'extender' ); ?></label><br />
					<input id="meta[disable_genesis_extender_images_menu]" name="meta[disable_genesis_extender_images_menu]" type="checkbox" value="1" <?php checked( get_the_author_meta( 'disable_genesis_extender_images_menu', $user->ID ) ); ?> />
					<label for="meta[disable_genesis_extender_images_menu]"><?php _e( 'Disable Genesis Extender Images Submenu?', 'extender' ); ?></label><br />
				</td>
			</tr>
...
function genesis_extender_user_meta_save( $user_id )
{
	...
	$defaults = array(
		'disable_genesis_extender_admin_menu' => '',
		'disable_genesis_extender_custom_menu' => '',
		'disable_genesis_extender_images_menu' => '',
