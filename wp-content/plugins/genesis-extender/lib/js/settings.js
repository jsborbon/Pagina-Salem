...
jQuery(document).ready(function($) {
	...
	$('#genesis-extender-font-awesome-css').change(function() {
		var fa_css_active = $('#genesis-extender-font-awesome-css:checked').val();
		if( fa_css_active ) {
			$('#genesis-extender-font-awesome-cdn-option').animate({'height': 'show'}, { duration: 300 });
		} else {
			$('#genesis-extender-font-awesome-cdn-option').animate({'height': 'hide'}, { duration: 300 });
		}
	});
	$('#genesis-extender-font-awesome-css').change();
	
	$('#genesis-extender-font-awesome-cdn').change(function() {
		var fa_cdn_active = $('#genesis-extender-font-awesome-cdn:checked').val();
		if( fa_cdn_active ) {
			$('#genesis-extender-font-awesome-cdn-url-box').animate({'height': 'show'}, { duration: 300 });
		} else {
			$('#genesis-extender-font-awesome-cdn-url-box').animate({'height': 'hide'}, { duration: 300 });
		}
	});
	$('#genesis-extender-font-awesome-cdn').change();
	...
	$('#settings-export-check-all').click( function() {
		$('.settings-export-check').attr('checked', true);
	});
	
	$('#settings-export-uncheck-all').click( function() {
		$('.settings-export-check').attr('checked', false);
	});

	$('#settings-import-check-all').click( function() {
		$('.settings-import-check').attr('checked', true);
	});
	
	$('#settings-import-uncheck-all').click( function() {
		$('.settings-import-check').attr('checked', false);
	});
