...
//                            $basename  = $this->admin->filter_filename($basename);
    ...
    public function save_image($img_src = "", $found_on = "")
    {
        ...
        if (strpos($img_src, 'data:') == false) {
            ...
            if (!$this->admin->is_link_exists($img_src) && !$this->admin->is_failed_file($img_src)) {
