...
class extract_scripts
{
    ...
    public function save_scripts($script_url_prev = "", $found_on = "")
    {
        ...
        if (!$this->admin->is_link_exists($script_url_prev) && !$this->admin->is_failed_file($script_url)) {
            ...
            if (!file_exists($my_file)) {
                $abs_url_to_path = $this->admin->abs_url_to_path($script_url);
                if (strpos($script_url, $host) !== false && file_exists($abs_url_to_path)){
                    ...
                    $data = $this->admin->get_url_data($script_url);
