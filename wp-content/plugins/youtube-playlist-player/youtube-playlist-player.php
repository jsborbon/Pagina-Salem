 ...
 * Copyright (C) 2013-2022 Ciprian Popescu (getbutterfly@gmail.com)
 *
 ...
 */
function ytpp_pss() {
    wp_register_style( 'ytpp', plugins_url( 'css/style.min.css', __FILE__ ), [], '4.6.2' );

    wp_register_script( 'ytpp', plugins_url( 'js/ytpp-main.min.js', __FILE__ ), [], '4.6.2', true );

    if ( (int) get_option( 'ytpp_iframe_fix' ) === 1 ) {
        wp_register_script( 'ytpp-fluid-vids', plugins_url( 'js/ytpp-fluid-vids.min.js', __FILE__ ), [], '4.6.2', true );
    }
}
