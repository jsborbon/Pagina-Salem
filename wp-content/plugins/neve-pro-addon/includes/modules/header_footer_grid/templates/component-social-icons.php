...
<div class="component-wrap">
	<ul class="nv-social-icons-list">
		...
		foreach ( $social_icons as $social_icon ) {
			...
			$icon_style .= empty( $social_icon['background_color'] ) ? '' : 'background:' . $social_icon['background_color'] . ';';
			?>
			<li>
				<a href="<?php echo esc_url( $social_icon['url'] ); ?>"
					<?php echo esc_attr( $target ); ?> style="<?php echo esc_attr( $icon_style ); ?>" title="<?php echo esc_attr( $social_icon['title'] ); ?>" aria-label="<?php echo esc_attr( $social_icon['title'] ); ?>">
					<?php echo neve_kses_svg( $icon ); ?>
				</a>
			</li>
			<?php
		}
