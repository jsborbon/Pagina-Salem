...
class Shop_Page {
	...
	public function register_hooks() {
		...
		if ( Elementor::has_template( 'product-archive' ) ) {
			return;
		}
	...
	public function load_more_products_sentinel() {
		echo '<div class="load-more-products"><span class="sp-loader" style="display: none;"></span><span class="infinite-scroll-trigger"></span></div>';
	}
