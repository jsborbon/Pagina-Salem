...
jQuery(document).ready(function($) {
	...
	$('#show-hide-custom-css-builder').click(function() {
		$('#genesis-extender-custom-php-builder').hide();
		$('#genesis-extender-custom-css-builder').animate({'height': 'toggle'}, { duration: 300 });
		// Variables
		var genesis_extender_css_builder_nav_all = $('.genesis-extender-css-builder-nav-all');
		
		genesis_extender_css_builder_nav_all.click(function() {
			var css_nav_id = $(this).attr('id');
			$('.genesis-extender-all-css-builder').hide();
			$('#'+css_nav_id+'-box').show();
			genesis_extender_css_builder_nav_all.removeClass('genesis-extender-options-nav-active');
			$('#'+css_nav_id).addClass('genesis-extender-options-nav-active');
		});
	});
	...
	$('#css-builder-output-insert').click(function() {
		...
		$('#genesis-extender-custom-css').insertAtCaret(new_custom_css);
